...
if __name__ == '__main__':
    spider = Spider()
    # 运行过程出现404和200属正常情况
    spider.download_icon_unit(start=800, end=2000, star=3)
    spider.download_icon_unit(start=800, end=2000, star=6)
    # spider.download_icon_unit(start=1600, end=1805, star=3)
    # 如果需要爬取漫画，取消掉下面的这行注释
