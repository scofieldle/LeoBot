...
CHARA_NAME = {
    ...
    1001: ["日和", "春咲日和莉", "ヒヨリ", "Hiyori", "日和莉", "猫拳", "🐱👊"],
    1002: ["优衣", "草野优衣", "ユイ", "Yui", "种田", "普田", "由衣", "结衣", "ue", "↗↘↗↘"],
    1003: ["怜", "士条怜", "レイ", "Rei", "剑圣", "普怜", "伶"],
    1004: ["禊", "穗高未奏希", "ミソギ", "Misogi", "未奏希", "炸弹", "炸弹人", "💣"],
    1005: ["茉莉", "织原茉莉", "マツリ", "Matsuri", "跳跳虎", "老虎", "虎", "🐅"],
    1006: ["茜里", "风宫茜里", "アカリ", "Akari", "妹法", "妹妹法"],
    1007: ["宫子", "出云宫子", "ミヤコ", "Miyako", "布丁", "布", "🍮"],
    1008: ["雪", "虹村雪", "ユキ", "Yuki", "小雪", "镜子", "镜法", "伪娘", "男孩子", "男孩纸"],
    1009: ["杏奈", "柊杏奈", "アンナ", "Anna", "中二", "煤气罐"],
    1010: ["真步", "姬宫真步", "マホ", "Maho", "狐狸", "真扎", "咕噜灵波", "真布", "🦊"],
    1011: ["璃乃", "衣之咲璃乃", "リノ", "Rino", "妹弓"],
    1012: ["初音", "柏崎初音", "ハツネ", "Hatsune", "hego", "星法", "星星法", "⭐法", "睡法"],
    1013: ["七七香", "丹野七七香", "ナナカ", "Nanaka", "娜娜卡", "77k", "77香"],
    1014: ["霞", "雾原霞", "カスミ", "Kasumi", "香澄", "侦探", "杜宾犬", "驴", "驴子", "🔍"],
    1015: ["美里", "爱川美里", "ミサト", "Misato", "圣母"],
    1016: ["铃奈", "美波铃奈", "スズナ", "Suzuna", "暴击弓", "暴弓", "爆击弓", "爆弓", "政委"],
    1017: ["香织", "喜屋武香织", "カオリ", "Kaori", "琉球犬", "狗子", "狗", "狗拳", "🐶", "🐕", "🐶👊🏻", "🐶👊"],
    1018: ["伊绪", "支仓伊绪", "イオ", "Io", "老师", "魅魔"],

    1020: ["美美", "茜美美", "ミミ", "Mimi", "兔子", "兔兔", "兔剑", "萝卜霸断剑", "人参霸断剑", "天兔霸断剑", "🐇", "🐰"],
    1021: ["胡桃", "栗林胡桃", "クルミ", "Kurumi", "铃铛", "🔔"],
    1022: ["依里", "风宫依里", "ヨリ", "Yori", "姐法", "姐姐法"],
    1023: ["绫音", "北条绫音", "アヤネ", "Ayane", "熊锤", "🐻🔨", "🐻"],

    1025: ["铃莓", "天野铃莓", "スズメ", "Suzume", "女仆", "妹抖"],
    1026: ["铃", "森近铃", "リン", "Rin", "松鼠", "🐿", "🐿️"],
    1027: ["惠理子", "仓石惠理子", "エリコ", "Eriko", "病娇"],
    1028: ["咲恋", "佐佐木咲恋", "サレン", "Saren", "充电宝", "青梅竹马", "幼驯染", "院长", "园长", "🔋", "普电"],
    1029: ["望", "樱井望", "ノゾミ", "Nozomi", "偶像", "小望", "🎤"],
    1030: ["妮诺", "ニノン", "Ninon", "妮侬", "扇子"],
    1031: ["忍", "上喜忍", "シノブ", "Shinobu", "普忍", "鬼父", "💀"],
    1032: ["秋乃", "藤堂秋乃", "アキノ", "Akino", "哈哈剑"],
    1033: ["真阳", "野户真阳", "マヒル", "Mahiru", "奶牛", "🐄", "🐮", "真☀"],
    1034: ["优花梨", "绫濑由加莉", "ユカリ", "Yukari", "由加莉", "黄骑", "酒鬼", "奶骑", "圣骑", "🍺", "🍺👻"],

    1036: ["镜华", "冰川镜华", "キョウカ", "Kyouka", "小仓唯", "xcw", "小苍唯", "8岁", "八岁", "喷水萝", "八岁喷水萝", "8岁喷水萝"],
    1037: ["智", "御久间智", "トモ", "Tomo", "卜毛"],
    1038: ["栞", "柏崎栞", "シオリ", "Shiori", "tp弓", "小栞", "白虎弓", "白虎妹"],

    1040: ["碧", "双叶碧", "アオイ", "Aoi", "香菜", "香菜弓", "绿毛弓", "毒弓", "绿帽弓", "绿帽"],

    1042: ["千歌", "三角千歌", "チカ", "Chika", "绿毛奶"],
    1043: ["真琴", "安艺真琴", "マコト", "Makoto", "狼", "🐺", "月月", "朋"],
    1044: ["伊莉亚", "イリヤ", "Iriya", "伊利亚", "伊莉雅", "伊利雅", "yly", "吸血鬼", "那个女人"],
    1045: ["空花", "远见空花", "クウカ", "Kuuka", "抖m", "抖"],
    1046: ["珠希", "宫坂珠希", "タマキ", "Tamaki", "猫剑", "🐱剑", "🐱🗡️"],
    1047: ["纯", "白银纯", "ジュン", "Jun", "黑骑", "saber"],
    1048: ["美冬", "大神美冬", "ミフユ", "Mifuyu", "子龙", "赵子龙"],
    1049: ["静流", "星野静流", "シズル", "Shizuru", "姐姐"],
    1050: ["美咲", "玉泉美咲", "ミサキ", "Misaki", "大眼", "👀", "👁️", "👁"],
    1051: ["深月", "宵滨深月", "ミツキ", "Mitsuki", "眼罩", "抖s"],
    1052: ["莉玛", "リマ", "Rima", "Lima", "草泥马", "羊驼", "🦙", "🐐"],
    1053: ["莫妮卡", "モニカ", "Monika", "毛二力"],
    1054: ["纺希", "茧宫纺希", "ツムギ", "Tsumugi", "裁缝", "蜘蛛侠", "🕷️", "🕸️"],
    1055: ["步未", "石桥步未", "アユミ", "Ayumi", "步美", "路人", "路人妹"],
    1056: ["流夏", "太刀洗流夏", "ルカ", "Ruka", "大姐", "大姐头"],
    ...
    1061: ["矛依未", "园上矛依未", "ムイミ", "Muimi", "诺维姆", "Noemu", "夏娜", "511", "无意义", "天楼霸断剑"],

    1063: ["亚里莎", "アリサ", "Arisa", "鸭梨瞎", "瞎子", "亚里沙", "鸭梨傻", "亚丽莎", "亚莉莎", "瞎子弓", "🍐🦐"],

    1065: ["嘉夜", "鬼道嘉夜", "カヤ", "Kaya", "憨憨龙", "🐲👊🏻", "🐉👊🏻"],
    1066: ["祈梨", "一之濑祈梨", "イノリ", "Inori", "梨老八", "李老八"],
    1067: ["穗希", "ホマレ", "Homare"],
    ...
    1109: ["琪爱儿", "风间琪爱儿", "チエル", "Chieru", "切露", "茄露", "茄噜", "切噜"],
