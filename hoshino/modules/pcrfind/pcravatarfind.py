...
def get_merge_avatar():
    num = random.randint(10,25) #难度
    ONE_TURN_TIME = (num-1)*2  #时间
    choose = random.randint(1,10) #选择近似头像
    if choose==1:
        ...
        avatar1 = R.img(f'priconne/unit/icon_unit_100411.png').open() #炸弹人
        avatar2 = R.img(f'priconne/unit/icon_unit_100411_2.png').open() #炸弹人-2
    elif choose==7:
        avatar1 = R.img(f'priconne/unit/icon_unit_100931.png').open() #中二
        avatar2 = R.img(f'priconne/unit/icon_unit_100931_2.png').open() #中二—2
    elif choose==8:
        avatar1 = R.img(f'priconne/unit/icon_unit_101311.png').open() #nnk
        avatar2 = R.img(f'priconne/unit/icon_unit_101311_2.png').open() #nnk-2
    elif choose==9:
        avatar1 = R.img(f'priconne/unit/icon_unit_106811.png').open() #晶
        avatar2 = R.img(f'priconne/unit/icon_unit_106811_2.png').open() #晶-2
    elif choose==10:
        avatar1 = R.img(f'priconne/unit/icon_unit_110911.png').open() #切噜
        avatar2 = R.img(f'priconne/unit/icon_unit_110911_2.png').open() #切噜-2
    w = num * SUB_PIC_SIZE
    h = num * SUB_PIC_SIZE
